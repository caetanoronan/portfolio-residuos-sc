    ...
    <style>
        * {{
        ...
        @media (max-width: 768px) {{
            ...
            /* Força cada gráfico a ocupar linha completa */
            .chart-container {{
        ...
        /* Toggle de modo compacto (desktop demo) */
        .compact-toggle {{
            position: fixed;
            top: 15px;
            right: 15px;
...
<body>
    <!-- Toggle de modo compacto (só desktop) -->
    <div class="compact-toggle">
        <input type="checkbox" id="force-compact" />
        <label for="force-compact" style="cursor: pointer; user-select: none;">📱 Modo Compacto (demo)</label>
    </div>
    ...
    <script>
        ...
        // Toggle de modo compacto (desktop demo)
        document.getElementById('force-compact').addEventListener('change', function() {{
            forceCompact = this.checked;
